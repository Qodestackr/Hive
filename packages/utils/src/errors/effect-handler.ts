...
import { type DomainErrorBase, isDomainError } from "./domain/base";
import { ErrorCode, PromcoError } from "./error";
...
export const effectErrorToPromcoError = (error: unknown): PromcoError => {
	...
	return new PromcoError(ErrorCode.INTERNAL_SERVER_ERROR, String(error), 500);
};
