import { type Span, trace, SpanStatusCode, SpanKind } from "@opentelemetry/api"
...
export async function withErrorTrace<T>(options: TraceOptions, fn: (span: Span) => Promise<T>): Promise<T> {
