...
export class CheckConstraintViolation extends Data.TaggedError("CheckConstraintViolation")<{
    readonly field: string | undefined
    readonly table: string | undefined
    readonly constraint: string | undefined
    readonly detail: string | undefined
...
export class DatabaseQueryTimeout extends Data.TaggedError("DatabaseQueryTimeout")<{
    readonly operation: string
    readonly pgCode: string
    readonly detail: string
}> {
...
export class GenericDatabaseError extends Data.TaggedError("GenericDatabaseError")<{
    readonly operation: string
    readonly table: string | undefined
...
export type DatabaseSchemaError =
    | UndefinedTable
    | UndefinedColumn
