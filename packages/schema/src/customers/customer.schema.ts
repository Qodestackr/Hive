...
// ============================================================================
// CUSTOMER SCHEMAS (THE GOLD: Verified Phone Numbers)
// ============================================================================

/**
 * Customer schema (matches DB)
 */
...
export const CustomerCreateSchema = z.object({
    ...
    // Opt-in
    hasOptedIn: z.boolean().default(false),
    optInSource: z.string().optional().openapi({ example: 'whatsapp_campaign' }),
 ...
 */
export const CustomerUpdateSchema = CustomerCreateSchema.partial().openapi('CustomerUpdate');

/**
 * Customer age verification input
 */
export const CustomerAgeVerificationSchema = z.object({
 ...
 */
export const CustomerOptInSchema = z.object({
    optInSource: z.string().optional().openapi({ example: 'whatsapp_campaign' }),
 ...
 */
export const CustomerOptOutSchema = z.object({
...
export const CustomerListQuerySchema = z.object({
    ...
    sortBy: z
        .enum(["name", "phoneNumber", "totalSpend", "totalOrders", "createdAt", "lastOrderAt"])
        .default("createdAt"),
 ...
 * Customer response
 */
export const CustomerResponseSchema = CustomerSchema.openapi('CustomerResponse');
...
/**
 * Bulk customer import response
 */
export const BulkCustomerImportResponseSchema = z.object({
    success: z.boolean(),
...
export type CustomerAgeVerification = z.infer<typeof CustomerAgeVerificationSchema>;
...
export type BulkCustomerImportResponse = z.infer<typeof BulkCustomerImportResponseSchema>;
