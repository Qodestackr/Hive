...
import { AlertSeverity, AlertType } from "../shared/enums.schema.js";

export const PromoProfitAlertSchema = z
	.object({
		id: z.string(),
...
export const PromoProfitAlertCreateSchema = z
	.object({
...
export const PromoProfitAlertResolveSchema = z
	.object({
...
export const PromoProfitAlertListQuerySchema = z
	.object({
...
export const PromoProfitAlertResponseSchema = PromoProfitAlertSchema.openapi(
	"PromoProfitAlertResponse",
);

export const PromoProfitAlertListResponseSchema = z
	.object({
...
export const PromoProfitAlertSummarySchema = z
	.object({
...
export type PromoProfitAlertCreate = z.infer<
	typeof PromoProfitAlertCreateSchema
>;
export type PromoProfitAlertResolve = z.infer<
	typeof PromoProfitAlertResolveSchema
>;
export type PromoProfitAlertListQuery = z.infer<
	typeof PromoProfitAlertListQuerySchema
>;
export type PromoProfitAlertResponse = z.infer<
	typeof PromoProfitAlertResponseSchema
>;
export type PromoProfitAlertListResponse = z.infer<
	typeof PromoProfitAlertListResponseSchema
>;
export type PromoProfitAlertSummary = z.infer<
	typeof PromoProfitAlertSummarySchema
>;
