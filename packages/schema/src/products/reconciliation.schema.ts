...
export const ReconcileProductSchema = z
	.object({
...
export const ReconcileAllProductsSchema = z
	.object({})
	.openapi("ReconcileAllProducts");

export const CorrectDiscrepancySchema = z
	.object({
...
export const ReconciliationResultSchema = z
	.object({
		isInSync: z.boolean().openapi({
			description:
				"True if ledger matches actual stock (within 1-unit tolerance)",
			example: false,
		}),
...
export const CorrectionSuccessSchema = z
	.object({
