...
export const InventoryMovementCreateSchema = z
	.object({
		...
		notes: z
			.string()
			.optional()
			.openapi({ example: "Damaged bottles removed" }),
 ...
 */
export const InventoryMovementResponseSchema = InventoryMovementSchema.openapi(
 ...
 */
export const InventoryMovementListResponseSchema = z
	.object({
 ...
 */
export const FIFOBatchInfoSchema = z
	.object({
		batchId: z.string(),
		productId: z.string(),
 ...
 */
export const ProductFIFOBatchesResponseSchema = z
	.object({
		productId: z.string(),
...
>;
export type InventoryMovementListQuery = z.infer<
...
export type ProductFIFOBatchesResponse = z.infer<
	typeof ProductFIFOBatchesResponseSchema
>;
