 ...
 */
export const PurchaseOrderItemCreateSchema = z
	.object({
		productId: z
			.string()
...
export const PurchaseOrderCreateSchema = z
	.object({
		supplierName: z
			.string()
			.optional()
			.openapi({ example: "ABC Distributors" }),
		supplierContact: z
			.string()
			.optional()
 ...
 */
export const QuickStockArrivalSchema = z
	.object({
		productId: z
			.string()
...
export const PurchaseOrderListQuerySchema = z
	.object({
		...
		sortBy: z
			.enum(["poNumber", "orderDate", "receivedDate", "totalCost", "createdAt"])
			.default("createdAt"),
		sortOrder: z.enum(["asc", "desc"]).default("desc"),
	})
	.openapi("PurchaseOrderListQuery");

export const PurchaseOrderResponseSchema = PurchaseOrderSchema.openapi(
	"PurchaseOrderResponse",
);

export const PurchaseOrderListResponseSchema = z
	.object({
...
export type PurchaseOrderItemCreate = z.infer<
