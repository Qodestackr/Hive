...
export const OutcomeInvoiceGenerateSchema = z
	.object({
...
export const OutcomeInvoiceSchema = z
	.object({
		id: z.string(),
...
export const OutcomeInvoiceListQuerySchema = z
	.object({
...
export const OutcomeInvoiceListResponseSchema = z
	.object({
...
export type OutcomeInvoiceGenerate = z.infer<
	typeof OutcomeInvoiceGenerateSchema
>;
export type OutcomeInvoice = z.infer<typeof OutcomeInvoiceSchema>;
export type OutcomeInvoiceListQuery = z.infer<
	typeof OutcomeInvoiceListQuerySchema
>;
export type OutcomeInvoiceListResponse = z.infer<
	typeof OutcomeInvoiceListResponseSchema
>;
