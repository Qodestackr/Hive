...
export const purchaseOrders = pgTable('purchase_order', {
  ...
  uniqueIndex('purchase_order_org_po_number_idx').on(table.organizationId, table.poNumber),
...
export const purchaseOrderItems = pgTable('purchase_order_item', {
  ...
  index('purchase_order_item_product_created_idx').on(table.productId, table.createdAt),
]);