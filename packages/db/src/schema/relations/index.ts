...
export const campaignResponsesRelations = relations(
	campaignResponses,
	({ one }) => ({
...
export const outcomeSnapshotsRelations = relations(
	outcomeSnapshots,
	({ one }) => ({
		organization: one(organizations, {
...
export const promoProfitAlertsRelations = relations(
	promoProfitAlerts,
	({ one }) => ({
		organization: one(organizations, {
