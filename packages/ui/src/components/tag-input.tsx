                        ...
                        <div className="p-2 sm:p-1.5 flex flex-wrap gap-2 sm:gap-1.5">
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        selectedIndex === index
                                            ...
                                            : 'bg-zinc-50 text-zinc-700 border border-zinc-300 hover:border-zinc-400 dark:bg-slate-800/50 dark:text-zinc-300 dark:border-zinc-700 dark:hover:border-zinc-600',
                                    )}
                                >
                                    {suggestion.label}
                            ...
                            {canAddNewTag && (
                                <button
                                    type="button"
                                    onClick={() => {
                                        const colorKeys = Object.keys(tagStyles.colors) as (keyof typeof tagStyles.colors)[];

                                        const randomColor =
                                            tagStyles.colors[
                                            colorKeys[Math.floor(Math.random() * colorKeys.length)] as keyof typeof tagStyles.colors
                                            ];
                                        addTag({
                                            id: input,
                                            label: input,
