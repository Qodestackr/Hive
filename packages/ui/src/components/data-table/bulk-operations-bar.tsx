...
import { Archive, Download, Edit, Send, Trash2, X } from "lucide-react";
				...
				<div className="flex items-center gap-1">
					{onBulkEdit && (
						<Button
							...
							size="sm"
							onClick={() =>
								handleBulkAction(() => onBulkEdit(selectedData), "Bulk edit")
							}
							className="h-8"
						>
					...
					{onBulkExport && (
						<Button
							...
							size="sm"
							onClick={() =>
								handleBulkAction(() => onBulkExport(selectedData), "Export")
							}
							className="h-8"
						>
					...
					{onBulkSend && (
						<Button
							...
							size="sm"
							onClick={() =>
								handleBulkAction(() => onBulkSend(selectedData), "Send")
							}
							className="h-8"
						>
						...
						<>
							...
							{onBulkDelete && (
								<Button
									...
									size="sm"
									onClick={() =>
										handleBulkAction(() => onBulkDelete(selectedData), "Delete")
									}
									className="h-8"
								>
