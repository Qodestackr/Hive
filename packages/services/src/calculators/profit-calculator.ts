 ...
 * Profit Calculator
 * 
 * Pure deterministic functions for profit calculations.
 * Extracted from services to enable:
 * - Testing without database
 * - AI agent profit previews
 * - Reusability across services
 * 
 * THE GOLD: These calculations determine if promos make or lose money.
 * They must be flawless and deterministic.
 */
...
export class ProfitCalculator {
    ...
    static calculate(params: ProfitCalculationParams): ProfitCalculationResult {
        const { basePrice, quantity, discountType, discountValue, unitCost } = params;
     ...
     */
    static calculateBreakEven(params: BreakEvenCalculationParams): BreakEvenCalculationResult {
