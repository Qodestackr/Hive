import { withErrorTrace } from "@repo/utils"
import { SpanKind } from "@repo/utils"
...
export async function withCacheOperation<T>(options: CacheOperationOptions, fn: () => Promise<T>): Promise<T> {
