 ...
 */
export class SaleorProductNotFound extends Data.TaggedError(
 ...
 */
export class SaleorVariantNotFound extends Data.TaggedError(
 ...
 */
export class SaleorStockUpdateFailed extends Data.TaggedError(
 ...
 */
export class SaleorProductCreationFailed extends Data.TaggedError(
	"SaleorProductCreationFailed",
)<{
	readonly productName: string;
	readonly reason: string;
	readonly saleorErrors?: Array<{
		field?: string;
		message: string;
		code?: string;
	}>;
 ...
 */
export class SaleorPromotionError extends Data.TaggedError(
 ...
 */
export class SaleorInvalidChannelConfig extends Data.TaggedError(
 ...
 */
export class SaleorRateLimitExceeded extends Data.TaggedError(
 ...
 */
export class SaleorChannelCreationFailed extends Data.TaggedError(
 ...
 */
export class SaleorWarehouseCreationFailed extends Data.TaggedError(
 ...
 */
export class SaleorShippingZoneCreationFailed extends Data.TaggedError(
 ...
 */
export class SaleorChannelActivationFailed extends Data.TaggedError(
 ...
 */
export class SaleorResourceAlreadyExists extends Data.TaggedError(
