...
export function UserInviteEmail({
	...
	return (
		<Html>
			<Head />
			<Preview>
				You've been invited to join {organizationName} on Promco Platform
			</Preview>
			<Body style={main}>
				<Container style={container}>
					...
					<Text style={text}>
						...
						<strong>{organizationName}</strong> on Promco Platform as a{" "}
						<strong>{role}</strong>.
					</Text>
					...
					<Text style={text}>
						Promco Platform helps teams manage their business operations, track
						inventory, monitor sales, and collaborate effectively. Join your
						team to get started!
					</Text>
					...
					<Section style={infoBox}>
						<Text style={infoText}>
							💡 This invitation will expire in {expiresIn}. If you don't have
							an Promco Platform account yet, one will be created for you when
					...
					<Text style={text}>
						...
						started, feel free to contact our support team.
					</Text>
