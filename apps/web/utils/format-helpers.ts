 ...
 */
export function formatCurrency(value: number | null | undefined, currency = "KES"): string {
 ...
 */
export function calculatePercentage(current: number | null | undefined, total: number | null | undefined): number {
