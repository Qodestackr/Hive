			...
			<div className="bg-zinc-50/50 p-3 pb-2 dark:bg-zinc-900/50">
				...
				{aiInsight && (
					<div className="mt-4 rounded-lg border border-indigo-200 bg-indigo-50/50 p-3 dark:border-indigo-900/30 dark:bg-indigo-950/30">
						...
						<p className="text-xs leading-relaxed text-indigo-900/80 dark:text-indigo-100/70">
							{aiInsight}
						</p>
					</div>
				)}
			...
			<CardContent className="space-y-5 my-1 p-2">
				<div className="space-y-4 text-sm">
					...
					<div className="space-y-1">
						<div className="flex justify-between">
							<span className="text-zinc-600 dark:text-zinc-400">
								Customer captures ({captures.count} verified)
							</span>
							<span className="font-medium text-zinc-900 dark:text-zinc-50">
								{formatMoney(captures.total)}
							</span>
						</div>
					...
					<div className="space-y-2">
						<span className="text-zinc-600 dark:text-zinc-400">
							Profit share ({campaigns.length} campaigns)
						</span>
									...
									<div className="flex-1">
										...
										<div className="text-zinc-500 dark:text-zinc-500">
											{campaign.threshold ? (
												...
												<span>
													+{formatMoney(campaign.profit)} profit →{" "}
													{formatMoney(campaign.fee)} (5%)
												</span>
											)}
										</div>
									</div>
				...
				<Dialog>
					...
					<DialogContent className="max-h-[80vh] max-w-2xl overflow-y-auto">
						...
						<div className="space-y-2 py-2">
									...
									<CollapsibleContent>
										<div className="border-t border-zinc-200 bg-zinc-50/50 p-2 text-sm dark:border-zinc-800 dark:bg-zinc-900/50">
											<p className="text-zinc-600 dark:text-zinc-400">
												Fixed monthly fee covering platform infrastructure,
												WhatsApp Business API costs, compliance monitoring, and
												customer support.
											</p>
							...
							{/* Captures Details */}
							<Collapsible
								open={openSections.captures}
								onOpenChange={() => toggleSection("captures")}
							>
								<div className="rounded-lg border border-zinc-200 dark:border-zinc-800">
									<CollapsibleTrigger className="flex w-full items-center justify-between p-2 hover:bg-zinc-50 dark:hover:bg-zinc-900">
										<div className="flex items-center gap-3">
											...
											<div className="text-left">
												...
												<p className="text-xs text-zinc-500 dark:text-zinc-400">
													{captures.count} verified customers
												</p>
											</div>
										</div>
										<div className="flex items-center gap-2">
									...
									<CollapsibleContent>
										<div className="border-t border-zinc-200 bg-zinc-50/50 p-2 dark:border-zinc-800 dark:bg-zinc-900/50">
											<div className="mb-1 text-sm text-zinc-600 dark:text-zinc-400">
												Age-verified retail customers added to your database.
												Rate: {formatMoney(captures.rate)} per capture.
											</div>
											<div className="space-y-2">
												...
												{captures.count > 3 && (
													<p className="pt-1 text-center text-xs text-zinc-500">
														+ {captures.count - 3} more captures
													</p>
												)}
											</div>
										</div>
									...
									<div className="rounded-lg border border-zinc-200 dark:border-zinc-800">
										...
										{campaign.transactions && (
											<CollapsibleContent>
												<div className="border-t border-zinc-200 bg-zinc-50/50 p-2 dark:border-zinc-800 dark:bg-zinc-900/50">
													<div className="mb-1 text-sm text-zinc-600 dark:text-zinc-400">
														5% profit share on campaign earnings. FIFO cost
														tracking ensures accurate profit calculation.
													</div>
													<div className="space-y-2">
															...
															>
																...
																<div className="grid grid-cols-2 gap-x-4 gap-y-1.5 text-zinc-600 dark:text-zinc-400">
																	...
																	<div className="flex justify-between">
																		...
																		<span>
																			-{formatMoney(txn.discountApplied)}
																		</span>
																	</div>
