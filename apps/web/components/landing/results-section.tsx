...
export function ResultsSection() {
	const testimonials = [
		{
			quote:
				"I was about to run 30% off Hennessy. Promco showed me I'd lose KES 18,000. Adjusted to 15% and made KES 12,000 instead.",
			author: "David Kimani",
		...
		{
			quote:
				"We ran promos every week but never knew which ones actually made money. Now we know before we even launch.",
		...
		{
			quote:
				"The calculator alone is worth it. We check every promo idea now. Last month we killed 3 campaigns that would have lost us money.",
			author: "James Omondi",
