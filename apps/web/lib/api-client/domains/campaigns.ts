...
type CampaignCreate = NonNullable<paths["/api/v1/campaigns"]["post"]["requestBody"]>["content"]["application/json"];
type CampaignUpdate = NonNullable<paths["/api/v1/campaigns/{id}"]["patch"]["requestBody"]>["content"]["application/json"];
type CampaignListQuery = paths["/api/v1/campaigns"]["get"]["parameters"]["query"];
type ProfitabilityCheck = NonNullable<paths["/api/v1/campaigns/profit-check"]["post"]["requestBody"]>["content"]["application/json"];
