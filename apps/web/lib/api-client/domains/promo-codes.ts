...
type PromoCodeCreate = NonNullable<paths["/api/v1/promo-codes"]["post"]["requestBody"]>["content"]["application/json"];
type PromoCodeRedeem = NonNullable<paths["/api/v1/promo-codes/redeem"]["post"]["requestBody"]>["content"]["application/json"];
type PromoCodeValidate = NonNullable<paths["/api/v1/promo-codes/validate"]["post"]["requestBody"]>["content"]["application/json"];
type BulkPromoCodeCreate = NonNullable<paths["/api/v1/promo-codes/bulk"]["post"]["requestBody"]>["content"]["application/json"];
type PromoCodeListQuery = paths["/api/v1/promo-codes"]["get"]["parameters"]["query"];
